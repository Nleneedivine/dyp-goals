    ...
    <div className="min-h-screen pt-20 pb-12 font-poppins">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-7xl mx-auto mb-16">
              ...
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">info@dypgoals.com</p>
                    <p className="text-muted-foreground">support@dypgoals.com</p>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">123 Purpose Drive</p>
                    <p className="text-muted-foreground">Goals City, GC 12345</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          {/* Contact Form */}
          <Card className="lg:col-span-2 bg-card border-border animate-fade-in" style={{ animationDelay: '0.1s' }}>
            <CardHeader>
        ...
        <Card className="bg-gradient-to-r from-primary/20 via-secondary/20 to-accent/20 border-0 max-w-4xl mx-auto mb-12">
          <CardContent className="p-8 md:p-12">
            ...
            <form onSubmit={handleNewsletterSubmit} className="flex flex-col sm:flex-row gap-4 max-w-2xl mx-auto">
              ...
              <Button
                type="submit"
                className="bg-gradient-to-r from-secondary to-accent hover:opacity-90 font-semibold text-lg px-8 py-6"
              >
                Subscribe
              </Button>
            </form>
        ...
        <div className="text-center">
          ...
          <div className="flex justify-center gap-6">
            <a
              href="#"
              className="w-14 h-14 bg-gradient-to-br from-primary to-secondary rounded-full flex items-center justify-center hover:opacity-80 transition-opacity"
            >
              <Facebook className="h-6 w-6 text-primary-foreground" />
            </a>
            <a
              href="#"
              className="w-14 h-14 bg-gradient-to-br from-secondary to-accent rounded-full flex items-center justify-center hover:opacity-80 transition-opacity"
            >
              <Twitter className="h-6 w-6 text-secondary-foreground" />
            </a>
            <a
              href="#"
              className="w-14 h-14 bg-gradient-to-br from-accent to-primary rounded-full flex items-center justify-center hover:opacity-80 transition-opacity"
            >
              <Instagram className="h-6 w-6 text-accent-foreground" />
            </a>
            <a
              href="#"
              className="w-14 h-14 bg-gradient-to-br from-primary to-accent rounded-full flex items-center justify-center hover:opacity-80 transition-opacity"
            >
              <Linkedin className="h-6 w-6 text-primary-foreground" />
            </a>
            <a
              href="#"
              className="w-14 h-14 bg-gradient-to-br from-secondary to-primary rounded-full flex items-center justify-center hover:opacity-80 transition-opacity"
            >
