# GOALS / DYP Refresh Roadmap

- [x] Add supplied brand assets, favicon, and teal semantic design system
- [x] Refresh shared header, footer, login, and home experience
- [x] Add secure form-builder database schema and public submission model
- [x] Build admin forms list and drag-and-drop editor with AI drafting
